...
describe("Auth Control Helper Test Functions", () => {
    ...
    it("function : auth_user_error", done => {
        const result = helper.auth_user_error(testObjects.verifiedDataObj, testObjects.reqBodyDataObj); // check error
        expect(result).to.be.undefined; // undefined  ->  no error
        done();
    });
    ...
    it("function : auth_post_error", done => {
        const result = helper.auth_post_error(testObjects.verifiedDataObj, testObjects.reqBodyDataObj);
    ...
    it("function : auth_post_verified_error", done => {
        const result = helper.auth_post_verified_error(testObjects.verifiedDataObj, testObjects.reqBodyDataObj);
        expect(result).to.be.undefined;
        done();
    });
});
...
describe("Auth Control Helper Test Functions - Error", () => {
    ...
    it("function : auth_user_error (not active)", done => {
        const result = helper.auth_user_error(testObjects.verifiedDataObj_active_error, testObjects.reqBodyDataObj); // check error
        expect(result).to.be.true; // true  ->  there is an error
        done();
    });
    ...
    it("function : auth_user_error (_id no matches)", done => {
        const result = helper.auth_user_error(testObjects.verifiedDataObj, testObjects.reqBodyDataObj_error); // check error
        expect(result).to.be.true; // true  ->  there is an error
        done();
    });
    ...
    it("function : auth_post_error (not active)", done => {
        const result = helper.auth_post_error(testObjects.verifiedDataObj_active_error, testObjects.reqBodyDataObj);
    ...
    it("function : auth_post_error (userId no matches)", done => {
        const result = helper.auth_post_error(testObjects.verifiedDataObj, testObjects.reqBodyDataObj_error);
        expect(result).to.be.true;
        done();
    });
    ...
    it("function : auth_post_verified_error (not active)", done => {
        const result = helper.auth_post_verified_error(testObjects.verifiedDataObj_active_error, testObjects.reqBodyDataObj);
        expect(result).to.be.true;
        done();
    });
    ...
    it("function : auth_post_verified_error (not verified)", done => {
        const result = helper.auth_post_verified_error(testObjects.verifiedDataObj_verified_error, testObjects.reqBodyDataObj);
        expect(result).to.be.true;
        done();
    });
    ...
    it("function : auth_post_verified_error (userId no matches)", done => {
        const result = helper.auth_post_verified_error(testObjects.verifiedDataObj, testObjects.reqBodyDataObj_error);
        expect(result).to.be.true;
        done();
    });
});